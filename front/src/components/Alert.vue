<template>
  <div
    ...
    class="p-4 mb-4 bg-green-100 rounded-lg dark:bg-green-200"
    role="alert"
  >
    ...
    <div class="flex">
      ...
      <button
        ...
        class="
          ...
          py-1.5
          text-center
          dark:border-green-800 dark:text-green-800 dark:hover:text-white
        "
        data-collapse-toggle="alert-additional-content-3"
        aria-label="Close"
      >
        Dismiss
      </button>
